...
## MCP Comparison Note (2026-04-19)
- For feature-level comparison and TDD usage guidance between `@coding-solo/godot-mcp` and `gopeak`, see `docs/MCP_SERVER_COMPARISON.md`.
